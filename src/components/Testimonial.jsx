...
function Testimonial() {
  const testimonials = [
    ...
    {
      id: 2,
      text: `Viki's diligence and attitude to work are extremely motivating. Precise and conscientious, she always moved towards solutions. She is a real team player who made the work even more colorful with her personality and good humor. She did not shy away from management, she was always honest and ready to share her opinion, which resulted in a successful project. I was very happy to be on a team with Viki, and I hope to have the opportunity to work with her in the future.`,
      author: 'Diana Dobozi',
      profession: 'Full Stack Developer',
    },
  ];
